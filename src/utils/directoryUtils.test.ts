...
test('Flattening a directory including directories should return a list of only files', () => {
...
test('Flattening a directory excluding directories should return a list of files/dirs', () => {
